...
public class AnalysisOutput implements Cloneable {
	...
	public String toString() {
		...
		if(this.getNsfx()!=null)
			buff.append(",").append(MorphUtil.buildTypeString(this.getNsfx(),PatternConstants.POS_SFX_N));

		if(this.getPatn()==PatternConstants.PTN_NJ || this.getPatn()==PatternConstants.PTN_ADVJ) {
			buff.append(",").append(MorphUtil.buildTypeString(this.getJosa(),PatternConstants.POS_JOSA));
		}else if(this.getPatn()==PatternConstants.PTN_NSM) {
			buff.append(",").append(MorphUtil.buildTypeString(this.getVsfx(),PatternConstants.POS_SFX_V));
			if(this.getPomi()!=null)
				buff.append(",").append(MorphUtil.buildTypeString(this.getPomi(),PatternConstants.POS_PEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.getEomi(),PatternConstants.POS_EOMI));
		}else if(this.getPatn()==PatternConstants.PTN_NSMJ) {
			buff.append(",").append(MorphUtil.buildTypeString(this.getVsfx(),PatternConstants.POS_SFX_V));
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(0),PatternConstants.POS_NEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.getJosa(),PatternConstants.POS_JOSA));
		}else if(this.getPatn()==PatternConstants.PTN_NSMXM) {
			buff.append(",").append(MorphUtil.buildTypeString(this.getVsfx(),PatternConstants.POS_SFX_V));
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(0),PatternConstants.POS_COPULA));
			buff.append(",").append(MorphUtil.buildTypeString(this.getXverb(),PatternConstants.POS_XVERB));
			if(this.getPomi()!=null)
				buff.append(",").append(MorphUtil.buildTypeString(this.getPomi(),PatternConstants.POS_PEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.getEomi(),PatternConstants.POS_EOMI));
		}else if(this.getPatn()==PatternConstants.PTN_NJCM) {
			buff.append(",").append(MorphUtil.buildTypeString(this.getJosa(),PatternConstants.POS_JOSA));
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(0),PatternConstants.POS_SFX_V));
			if(this.getPomi()!=null)
				buff.append(",").append(MorphUtil.buildTypeString(this.getPomi(),PatternConstants.POS_PEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.getEomi(),PatternConstants.POS_EOMI));
		}else if(this.getPatn()==PatternConstants.PTN_VM) {
			if(this.getPomi()!=null)
				buff.append(",").append(MorphUtil.buildTypeString(this.getPomi(),PatternConstants.POS_PEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.getEomi(),PatternConstants.POS_EOMI));
		}else if(this.getPatn()==PatternConstants.PTN_VMJ) {
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(0),PatternConstants.POS_NEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.getJosa(),PatternConstants.POS_JOSA));
		}else if(this.getPatn()==PatternConstants.PTN_VMCM) {
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(0),PatternConstants.POS_NEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(1),PatternConstants.POS_SFX_N));
			if(this.getPomi()!=null)
				buff.append(",").append(MorphUtil.buildTypeString(this.getPomi(),PatternConstants.POS_PEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.getEomi(),PatternConstants.POS_EOMI));
		}else if(this.getPatn()==PatternConstants.PTN_VMXM) {
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(0),PatternConstants.POS_COPULA));
			buff.append(",").append(MorphUtil.buildTypeString(this.getXverb(),PatternConstants.POS_XVERB));
			if(this.getPomi()!=null)
				buff.append(",").append(MorphUtil.buildTypeString(this.getPomi(),PatternConstants.POS_PEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.getEomi(),PatternConstants.POS_EOMI));
		}else if(this.getPatn()==PatternConstants.PTN_VMXMJ) {
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(1),PatternConstants.POS_COPULA));
			buff.append(",").append(MorphUtil.buildTypeString(this.getXverb(),PatternConstants.POS_XVERB));
			if(this.getPomi()!=null)
				buff.append(",").append(MorphUtil.buildTypeString(this.getPomi(),PatternConstants.POS_PEOMI));
			buff.append(",").append(MorphUtil.buildTypeString(this.elist.get(0),PatternConstants.POS_NEOMI));
